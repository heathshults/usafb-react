...
const PlayerInfo = props => (
  <div className="card-red player-info card-red-mspacing-top">
    <div className="card-red-body">
      ...
      <p>{props.playerData.gender} - {props.playerData.years_experience} years - {props.playerData.graduation_year} - {props.playerData.grade}th Grade
        ...
        Position: {props.currentTeam.positions && props.currentTeam.positions.map(position => `${position}, `)}</p>
    </div>
  </div>
);
